        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbar-collapse">
            <ul className="nav navbar-nav">
              <li><a id="planechase" href="#" onClick={() => this.props.changeTopLevelState('currentPage', 'plane')}>Planechase</a></li>
              <li><a id="searchPage" href="#" onClick={() => this.props.changeTopLevelState('currentPage', 'search')}>Search</a></li>
              <li><a id="toolsPage" href="#" onClick={() => this.props.changeTopLevelState('currentPage', 'tools')}>Tools</a></li>
            </ul>
